...
defined('EXIT_USER_INPUT')     OR define('EXIT_USER_INPUTencode', 7); // invalid user input
...
// define('CUSTOM_DATA_FIELD_IDS', array('105','106','107','109','110','111','112'));

define('EMAIL_VERIFICATION',false);
define('MOBILE_VERIFICATION',false);
define('BARCODE_REDIRECT_ON','form');

define('SITE_TITLE','CASTING');
define('INFO_EMAIL','info@argold.com');
define('HOSTVERSION', ' (Apr 2024)');
...
//define('ARF_AUG2022_DB_NAME', 'arf_aug2022_production');
//define('ARC_AUG2022_DB_NAME', 'arc_aug2022_production');
//define('ARGOLD_AUG2022_DB_NAME', 'argold_aug2022_production');


//define('ARF_URL', 'may2022-arf.ar-gold.in');
//define('ARC_URL', 'may2022-arc.ar-gold.in');
//define('ARGOLD_URL', 'may2022-argold.ar-gold.in');
//define('ARF_AUG2022_URL', 'aug2022-arf.ar-gold.in');
//define('ARC_AUG2022_URL', 'aug2022-arc.ar-gold.in');
