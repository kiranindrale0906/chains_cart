...
function list_settings() {
  return array(
    ...
    array("Required Gold", "pure_gold_weight", false, "pure_gold_weight", TRUE, TRUE,'melting_lots.pure_gold_weight as pure_gold_weight','','','range','',true),
    array("Alloy Weight", "alloy_weight", false, "alloy_weight", TRUE, TRUE,'melting_lots.alloy_weight as alloy_weight','','','range','',true),
