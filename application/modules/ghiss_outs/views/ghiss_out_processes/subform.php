<tr class="process_<?= $process['id']?>">
	...
	<td class="balance_ghiss"><?php echo four_decimal($process['balance_ghiss']);?></td>
	<td><?php echo four_decimal($process['balance_ghiss'] * ($process['wastage_purity'] / 100) * ($process['wastage_lot_purity'] / 100));?></td>
