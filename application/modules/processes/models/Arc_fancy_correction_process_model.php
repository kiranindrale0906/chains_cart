...
class Arc_fancy_correction_process_model extends Process_model{
	protected $next_process_model = 'arc_fancy_chains/arc_fancy_magnet_process_model';

	public $router_class = 'correction_processes';
	public $departments = array('Correction');
	public function __construct($data = array()){
		parent::__construct($data);
		$this->attributes['product_name'] = 'Arc Fancy';
		$this->attributes['process_name'] = 'Correction Process';
		$this->department_not_deleted=array('Correction');
		$this->split_out_weight_departments =array('Correction');
	}
