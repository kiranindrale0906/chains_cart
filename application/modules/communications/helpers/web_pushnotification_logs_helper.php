...
function getTableSettings() {
  return array(
    'page_title'          => 'Web Push Notifications Logs',
    'primary_table'       => 'library_web_pushnotification_logs',
    'default_column'      => 'id',
    'table'               => 'library_web_pushnotification_logs',
    'join_columns'        => '',
    'join_type'           => '',
    'where'               => '',
    'where_ids'           => '',
    ...
    'search_url'          => 'Web_pushnotification_logs',
    'add_title'           => '',
    'export_title'        => '',
    'edit'                => '',
    'select_column'       => true,
...
function list_settings() {
  return array(
    ...
    array("Response", "response", true, "response", true, true,'response'),
