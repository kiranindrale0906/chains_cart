<tr class="process_<?= $process['id']?>">
	...
	<td ><?php echo $process['rejected'];?></td>
	<td class="gross_weight"><?php echo $process['balance_rejected'];?></td>
	<td class="purity"><?php echo four_decimal($process['out_lot_purity']) ;?></td>
	<td class="fine"><?php echo four_decimal(($process['rejected'] * $process['out_lot_purity']) / 100); ?></td>
</tr>