...
<?php $this->load->view('reports/karigar_calculations/search');?>
        ...
        <table class="table table-bordered table-sm table-default">
          <thead>
            <tr>
              ...
              <th class="text-center">Bounch weight </th>
              <?php if(HOST == 'ARF') : ?>
          ...
          <tbody>
            <?php if(!empty($department['karigars'])) { 
              ...
              foreach ($department['karigars'] as $karigar) {
                ...
                $total_bounchout=$total_bounchout+$karigar['bounch_out'];
            ...
            <tr>
              ...
              <?php if($product_name!='Indo tally Chain' && $product_name!="Choco Chain") : ?>
              ...
              <?php endif; ?>
              <?php if ($product_name=="Choco Chain") : ?>
              ...
              <td class="text-right"><?php echo $karigar['bounch_out']; ?></td>
              <?php if(HOST == 'ARF') : ?>
              ...
              <td class="text-right"><?php echo $karigar['avg_out_weight']; ?></td>
              <?php if(!empty($product_name) && ($product_name=="Indo tally Chain" || $product_name=="Hollow Choco Chain" || $product_name=="Imp Italy Chain")) { ?>
              <td class="text-center"> 
                 <a href="<?=ADMIN_PATH.'reports/karigar_calculations/view/0?karigar_name='.$karigar['karigar_name'].'&parent_lot_name='.$karigar['parent_lot_name'].'&rate='.$karigar['rate'].'&date='.$karigar['date'].'&process_name='.$process_name.'&department_name='.$department_name.'&product_name='.@$product_name?>" class="btn_blue" target="_blank">View </a> 
              </td>  
              <?php } ?> 
            </tr>
            <?php } ?>
             <tr>
              ...
              <td class="text-right font-weight-bold"><?php echo $total_bounchout; ?></td>
              <?php if(HOST == 'ARF') : ?>
