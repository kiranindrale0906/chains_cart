<div class="row">
<div class="col-sm-12">
<h6 class='blue text-uppercase bold mb-3'>Melting Report</h6>
  ...
  <table class="table table-sm fixedthead table-default">
    ...
    <?php
      $total = 0;
      $total_fine = 0;
      if(!empty($record['melting_data'])){
        foreach ($record['melting_data'] as $index => $record) {
         ...
         <tr>
            ...
            <td><?= !empty($record['tounch_in'])?$record['tounch_in']:'-' ?></td>
            <td><?= !empty($record['tounch_no'])?$record['tounch_no']:'-' ?></td>
