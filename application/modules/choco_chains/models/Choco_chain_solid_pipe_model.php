...
class Choco_chain_solid_pipe_model extends Process_model{
  protected $next_process_model = 'office_outside/final_process_model';
  public $router_class = 'choco_chain_solid_pipes';
  ...
  public function __construct($data = array()){
    ...
    $this->attributes['process_name'] = 'Choco Chain Solid Pipe';
