...
class Choco_chain_cutting_pipe_model extends Process_model{
	protected $next_process_model = 'office_outside/final_process_model';
	public $router_class = 'choco_chain_cutting_pipes';
	public $departments = array('Melting Start', 'Melting', 'Flatting', 'Pipe Making','Cutting','Hand Cutting');
	
	public function __construct($data = array()){
		parent::__construct($data);
		$this->attributes['product_name'] = 'Office Outside';
		$this->attributes['process_name'] = 'Choco Chain Cutting Pipe';
