...
class Choco_chain_hollow_pipe_model extends Process_model{
	protected $next_process_model = 'office_outside/final_process_model';
	public $router_class = 'choco_chain_hollow_pipes';
	public $departments = array('Melting Start', 'Melting', 'Flatting','Pipe Making', 'AU+FE','Final','KitKat','Hand Cutting','HCL');
	
	public function __construct($data = array()){
		parent::__construct($data);
		$this->attributes['product_name'] = 'Office Outside';
		$this->attributes['process_name'] = 'Choco Chain Hollow Pipe';
