<?php echo form_open_multipart(get_form_action($controller,$action, $record), 'method="post" class="form-horizontal fields-group-sm form_radius_none"'); ?>
  <div class="row">
    ...
    ?>
    <?php load_field('dropdown', array('field'      => 'type',
                                       'option'     => $types,
                                       'controller' => 'choco_chain_bom_settings'));?>
    <?php load_field('dropdown', array('field'      => 'chain',
                                       'option'     => $chains,
                                       'controller' => 'choco_chain_bom_settings'));?>
    ...
    <?php load_field('dropdown', array('field'  => 'tone',
                                       'option' => get_melting_lots_tone()['Choco Chain']
                                      ));?>
    <?php 
    if ($action == 'edit' || $action == 'update')
