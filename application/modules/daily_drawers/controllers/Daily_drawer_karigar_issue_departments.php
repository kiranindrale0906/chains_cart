<?php
class Daily_drawer_karigar_issue_departments extends BaseController {
  public function __construct() {
    $this->_model='daily_drawer_karigar_issue_department_model';
    parent::__construct();
  ...
  public function _get_form_data() {
    ...
    if(HOST=='ARF'){
      $accounts=array('KA Chain');
    }elseif(HOST=='ARC'){
      $accounts=array('ARC');
    }else{
      $accounts=array('Rope Chain', 'Machine Chain', 'Choco Chain', 'Hollow Choco Chain', 'Imp Italy Chain', 
                      'Indo tally Chain', 'Sisma Chain', 'Round Box Chain', 
                      'Refresh', 'Fancy Chain', 'ARF');
    }
