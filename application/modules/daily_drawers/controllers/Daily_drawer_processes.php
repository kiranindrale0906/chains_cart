...
class Daily_drawer_processes extends BaseController {	
	public function __construct(){
    $this->_model='daily_drawer_process_model';
    parent::__construct();
  ...
  public function index() { 
    redirect(base_url().'daily_drawers/daily_drawer_processes/create');
  } 
