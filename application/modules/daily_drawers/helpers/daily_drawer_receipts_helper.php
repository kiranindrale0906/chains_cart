...
function getTableSettings() {
  ...
  if($show=='yes') $where='product_name="Daily Drawer Receipt"';
  else $where='product_name="Daily Drawer Receipt" and archive=0';
  
   $data= array(
    'page_title'          => 'Daily Drawer Receipt List',
    ...
    'search_url'          => 'daily_drawer_receipts',
    'add_title'           => 'Add Daily Drawer Receipt',
    'export_title'        => '',
    'edit'                => '',
...
function get_field_attribute($table, $field) {
  ...
  $attributes = array(
    ...
    'karigar'  => array('Karigar', 'Enter Karigar', TRUE, '', TRUE),
  );
