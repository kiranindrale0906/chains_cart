...
function getTableSettings() {
  return  array(
    ...
    'search_url'          => 'cz_processes',
    'add_title'           => 'Add CZ process Entries',
    'export_title'        => '',
    'import_title'        => ''
  );
}
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'daily_drawers/cz_processes';
