...
$w = 'W3';
 foreach ($tone_wastages as $index => $wastage) {
  ...
  ?>
    <tr>
      <td><?=$index?></td>
       ...
       <td>
        ...
        <?php
          ...
          //                               'href'=>ADMIN_PATH."issue_and_receipts/daily_drawer_wastage_ledgers/create?hook_kdm_purity=".$wastage['hook_kdm_purity'].""));
          // }
        ?>
      </td>
      ...
      <td>Wastage</td>
      <td class="text-right"><a href=<?=$href.'column=in_weight&&purity='.$wastage['hook_kdm_purity'].'&&tone='.$wastage['tone']?>><?=isset($wastage['in_weight'])?four_decimal($wastage['in_weight']):0;?></a></td>

     <td class="text-right"><a href=<?=$href.'column=out_weight&&purity='.$wastage['hook_kdm_purity'].'&&tone='.$wastage['tone']?>><?=isset($wastage['out_weight'])?four_decimal($wastage['out_weight']):0;?></a></td></td>

      <td class="text-right"><a href=<?=$href.'column=issue_weight&&purity='.$wastage['hook_kdm_purity'].'&&tone='.$wastage['tone']?>><?=isset($wastage['issue_weight'])?four_decimal($wastage['issue_weight']):0;?></a></td></td>

      <td class="text-right"><a href=<?=$href.'column=balance&&purity='.$wastage['hook_kdm_purity'].'&&tone='.$wastage['tone']?>><?=isset($wastage['balance'])?four_decimal($wastage['balance']):0;?></a></td>
