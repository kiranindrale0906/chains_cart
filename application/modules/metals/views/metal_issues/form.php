<form method="post" class="form-horizontal fields-group-sm form_radius_none" enctype="multipart/form-data"
  ...
  <div class="row">    
  <?php 
    load_field('hidden', array('field' => 'process_name','value'=>'Issue')); 
    load_field('dropdown', array('field' => 'type' ,'option'=>array(array('id'=>'Pure','name'=>'Pure'))));
    load_field('dropdown', array('field' => 'account' ,'option'=>@get_account_name()));
