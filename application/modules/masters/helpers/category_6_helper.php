...
function getTableSettings() {
  return array(
    'page_title'          => 'Category 6',
    'primary_table'       => 'category_6',
    'default_column'      => 'id',
    'table'               => 'category_6',
    'join_columns'        => '',
    'join_type'           => '',
    ...
    'search_url'          => 'category_6',
    'add_title'           => 'Add category 6',
    'export_title'        => '',
    'edit'                => '',
    'clear_filter'        => true,
  );
...
function get_row_actions($row, $url, $select_url, $filter) {
  ...
  $actions["edit"] = array('request' => "http", 
                           'url' => ADMIN_PATH.'masters/category_6/edit/'.$row['id'],
                           'confirm_message' => "",
                           'class' => 'text-primary');
  return $actions;
}
