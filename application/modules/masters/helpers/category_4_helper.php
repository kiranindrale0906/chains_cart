...
function getTableSettings() {
  return array(
    'page_title'          => 'Category 4',
    'primary_table'       => 'category_4',
    'default_column'      => 'id',
    'table'               => 'category_4',
    'join_columns'        => '',
    'join_type'           => '',
    ...
    'search_url'          => 'category_4',
    'add_title'           => 'Add category 4',
    'export_title'        => '',
    'edit'                => '',
    'clear_filter'        => true,
  );
...
function get_row_actions($row, $url, $select_url, $filter) {
  ...
  $actions["edit"] = array('request' => "http", 
                           'url' => ADMIN_PATH.'masters/category_4/edit/'.$row['id'],
                           'confirm_message' => "",
                           'class' => 'text-primary');
  return $actions;
}
