<?php
class Category_2_model extends BaseModel{
  protected $table_name = 'category_2';
  ...
  public function validation_rules($klass='') {
    $rules[] = array('field' => 'category_2[category_name]',
                     'label' => 'Category name',
    ...
    $rules[] = array('field' => 'category_2[chain_name]',
                     'label' => 'Chain name',
                     'rules' => array('trim','required'),
