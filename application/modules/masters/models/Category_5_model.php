<?php
class Category_5_model extends BaseModel{
  protected $table_name = 'category_5';
  ...
  public function validation_rules($klass='') {
    $rules[] = array('field' => 'category_5[category_name]',
                     'label' => 'Category name',
    ...
    $rules[] = array('field' => 'category_5[chain_name]',
                     'label' => 'Chain name',
                     'rules' => array('trim','required'),
