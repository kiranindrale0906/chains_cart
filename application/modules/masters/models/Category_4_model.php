<?php
class Category_4_model extends BaseModel{
  protected $table_name = 'category_4';
  ...
  public function validation_rules($klass='') {
    $rules[] = array('field' => 'category_4[category_name]',
                     'label' => 'Category name',
    ...
    $rules[] = array('field' => 'category_4[chain_name]',
                     'label' => 'Chain name',
                     'rules' => array('trim','required'),
