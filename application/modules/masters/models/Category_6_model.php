<?php
class Category_6_model extends BaseModel{
  protected $table_name = 'category_6';
  ...
  public function validation_rules($klass='') {
    $rules[] = array('field' => 'category_6[category_name]',
                     'label' => 'Category name',
    ...
    $rules[] = array('field' => 'category_6[chain_name]',
                     'label' => 'Chain name',
                     'rules' => array('trim','required'),
