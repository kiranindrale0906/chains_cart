...
function getTableSettings() {
  return array(
    'page_title'          => 'Issue and Receipt List',
...
function get_field_attribute($table, $field) {
  ...
  $attributes = array(
    ...
    'department_name' => array('Department Name', 'Select Department Name', FALSE, '', TRUE),
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'department_wise_ghiss_ledgers/department_wise_ghiss_ledgers';
