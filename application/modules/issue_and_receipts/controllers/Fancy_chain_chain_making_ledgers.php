...
class Fancy_chain_chain_making_ledgers extends Ledgers {
  ...
  public function index() {
    redirect(base_url().'issue_and_receipts/fancy_chain_chain_making_ledgers/create');
  }
  ...
  public function _get_form_data() {
    ...
    $this->data['karigar_name']=$this->same_karigar_model->get('Distinct(karigar_name) as name,karigar_name as id',
                                      array('product_name in ("Fancy Chain","Fancy 75 Chain")'=>NULL));
    
    // if (empty($this->data['record']['karigar'])) return;
    if (empty($this->data['record']['in_lot_purity'])) return;

    // $bounch_out_in_fields = 'p.lot_no as lot_no,
    //               p.karigar as product_name, 
    //               "Bounch Out In" as issue_type,
    //               (p.in_weight) as weight,
    //               p.in_lot_purity as purity, 
    //               (p.in_weight * p.in_lot_purity / 100) as fine, 
    ...
    $bounch_in_fields = 'processes.lot_no as lot_no,
                       process_details.next_department_karigar as product_name, 
                       "Bounch In" as issue_type, 
                       process_details.bounch_out as weight, 
                       processes.in_lot_purity as purity, 
                       process_details.bounch_out * processes.in_lot_purity / 100 as fine, 
                       date(process_details.created_at) as created_date, process_details.created_at as created_at';    
    ...
    $recutting_out_fields = 'processes.lot_no as lot_no,
                       ...
                       date(process_details.created_at) as created_date, process_details.created_at as created_at';    
    $bounch_out_fields = 'processes.lot_no as lot_no,
                       processes.karigar as product_name, 
                       "Bounch Out" as issue_type, 
                       process_details.bounch_out as weight, 
                       processes.in_lot_purity as purity, 
                       process_details.bounch_out * processes.in_lot_purity / 100 as fine, 
                       date(process_details.created_at) as created_date, process_details.created_at as created_at';    

    $in_where           = "process_details.out_weight != 0 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND processes.department_name = 'Fancy Hold'";
    $hook_in_where      = "process_details.hook_in != 0 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND processes.department_name = 'Chain Making'";
     $bounch_in_where         = "process_details.bounch_out != 0 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND processes.department_name = 'Chain Making' ";
    if(!empty($this->data['record']['in_lot_purity'])) {
      if ($this->data['record']['in_lot_purity'] == '83.65') {
        ...
        $bounch_in_where      .= ' and (processes.in_lot_purity >= 80 and processes.in_lot_purity < 85)' ;
        ...
        $bounch_in_where.=' and (processes.in_lot_purity >= 85 and processes.in_lot_purity < 88)' ;
        ...
        $bounch_in_where.=' and processes.in_lot_purity < 80' ;
    ...
    $query = $this->db->query("(select ".$in_fields." from processes inner join process_details on processes.id = process_details.process_id
                               where ".$in_where."
                              ...
                              UNION 
                               ...
                               order by created_at asc)
                              UNION 
                               (select ".$bounch_in_fields." from processes inner join process_details on processes.id = process_details.process_id
                               where ".$bounch_in_where."
                               order by processes.created_at asc)");
    $receipts = $query->result_array();
    $out_where          = "process_details.out_weight != 0           AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $hook_out_where     = "process_details.hook_out != 0             AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $customer_out_where = "process_details.customer_out != 0         AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $factory_out_where  = "processes.factory_out != 0          AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $wastage_where      = "process_details.daily_drawer_wastage != 0 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $ghiss_where        = "process_details.ghiss != 0 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $loss_where         = "processes.loss != 0                 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $tounch_in_where         = "processes.tounch_in != 0                 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $fire_tounch_in_where         = "processes.fire_tounch_in != 0                 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND department_name = 'Chain Making' ";
    $recutting_out_where         = "process_details.recutting_out != 0                 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND processes.department_name = 'Chain Making' ";
    $bounch_out_where         = "process_details.bounch_out != 0                 AND (processes.product_name = 'Fancy Chain' or processes.product_name = 'Fancy 75 Chain') AND processes.department_name = 'Chain Making' ";
    ...
    if(!empty($this->data['record']['karigar'])){
      ...
      $bounch_out_where.= " and processes.karigar='".$this->data['record']['karigar']."'";
    }
    ...
    $query = $this->db->query("(select ".$out_fields." from processes inner join process_details on processes.id = process_details.process_id
                            ...
                            UNION 
                               ...
                               order by processes.created_at asc)
                            UNION 
                               (select ".$bounch_out_fields." from processes inner join process_details on processes.id = process_details.process_id
