<?php echo form_open_multipart(get_form_action($controller,$action, $record), 'method="post" class="form-horizontal fields-group-sm form_radius_none"'); ?>
  <div class="row">
    ...
    <?php load_field('dropdown', array('field' => 'department_name','option'=>$department_names));?>
    <?php load_field('text', array('field' => 'karigar'));?>
    <?php load_field('text', array('field' => 'no_of_person'));?>
  </div>
