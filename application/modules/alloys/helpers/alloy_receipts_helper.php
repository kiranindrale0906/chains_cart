...
function getTableSettings() {
	return array(
		'page_title'          => 'Alloy Receipt List',
		'primary_table'       => 'processes',
		'default_column'      => 'id',
		'table'               => 'processes',
		'join_columns'        => '',
		'join_type'           => '',
		'where'               => 'product_name="Alloy Receipt" AND archive=0',
		'where_ids'           => '',
		'order_by'            => 'id desc',
		'limit'               => "20",
		...
		'search_url'          => 'alloy_receipts',
		'add_title'           => 'Add Alloy Receipt',
		'export_title'        => '',
		'edit'                => '',
	);
}
...
function list_settings() {
	return array(
		...
		array("Alloy WT", "alloy_weight", TRUE, "alloy_weight", TRUE, TRUE,'alloy_weight','','',
					'range','alloy_weight',true),
...
function get_field_attribute($table, $field) {
	...
	$attributes = array(
		...
		'alloy_weight'  => array('Gross Wt', 'Enter Gross Wt', TRUE, '', TRUE),
