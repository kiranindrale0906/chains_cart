...
function getTableSettings() {
  return array(
    'page_title'          => 'Rhodium Receipt List',
    'primary_table'       => 'processes',
    'default_column'      => 'id',
    'table'               => 'processes',
    'join_columns'        => '',
    'join_type'           => '',
    'where'               => 'product_name="Rhodium Receipt" and account!="" and archive=0',
    'where_ids'           => '',
    'order_by'            => 'id desc',
    'limit'               => "20",
    ...
    'search_url'          => 'rhodium_receipts',
    'add_title'           => 'Add Rhodium Receipt',
    'export_title'        => '',
    'edit'                => '',
  );
}
...
function list_settings() {
  return array(
    ...
    array("In WT", "melting_wastage", TRUE, "melting_wastage", TRUE, TRUE,'melting_wastage','','',
          'range','melting_wastage',true),
    array("Out WT", "out_melting_wastage", TRUE, "out_melting_wastage", TRUE, TRUE,
          'out_melting_wastage','','','range','out_melting_wastage',true),
    array("Balance WT", "balance_melting_wastage", TRUE, "balance_melting_wastage", TRUE, TRUE,
          'balance_melting_wastage','','','range','balance_melting_wastage',true),
