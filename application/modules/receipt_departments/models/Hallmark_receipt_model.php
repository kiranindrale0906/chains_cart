...
class Hallmark_receipt_model extends Process_model {
  protected $next_process_model = '';
  
  public $router_class = 'hallmark_receipts';
  public $departments = array('Start');
  
  public function __construct($data = array()) {
    parent::__construct($data);
    $this->attributes['product_name'] = 'Hallmark Receipt';
    $this->attributes['process_name'] = 'Hallmark Receipt';
  ...
  public function create_in_melting_wastage_record($process) {
    ...
    $process_obj = new Hallmark_receipt_model($start_process);
