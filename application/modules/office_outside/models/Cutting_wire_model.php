...
class Cutting_wire_model extends Process_model{
	protected $next_process_model = 'office_outside/final_process_model';
	public $router_class = 'cutting_wires';
	public $departments = array('Melting Start', 'Melting', 'Wire Making','Cutting');
	
	public function __construct($data = array()){
		parent::__construct($data);
		$this->attributes['product_name'] = 'Office Outside';
		$this->attributes['process_name'] = 'Cutting Wire';
		...
		$this->split_out_weight_departments = array('Cutting');
	}

	// public function after_save($action) {
 //    if($this->attributes['department_name']=='Cutting' && $this->attributes['daily_drawer_in_weight']!=0){
