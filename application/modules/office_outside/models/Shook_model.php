...
class Shook_model extends Process_model{
	protected $next_process_model = 'office_outside/final_process_model';
	public $router_class = 'shooks';
	public $departments = array('Melting Start', 'Melting', 'Tar Making', 'Round and Ball Chain', 'S Making');
	
	public function __construct($data = array()){
		parent::__construct($data);
		$this->attributes['product_name'] = 'Office Outside';
		$this->attributes['process_name'] = 'Shook';
		...
		$this->split_out_weight_departments = array('S Making');
	}
	// public function after_save($action) {
 //    if($this->attributes['department_name']=='S Making' && $this->attributes['daily_drawer_in_weight']!=0){
