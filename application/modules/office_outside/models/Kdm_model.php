...
class Kdm_model extends Process_model{
	...
	// public function after_save($action) {
	 //  	if($this->attributes['department_name']=='Stamping' && $this->attributes['daily_drawer_in_weight']!=0){
