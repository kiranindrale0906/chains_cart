...
function getTableSettings() {
   $show = (isset($_GET['show_all'])) ? $_GET['show_all'] : '';
    if($show=='yes') $where='product_name="Stone Transfer" and process_name="Factory To Karigar" and karigar = "Factory"';
    else $where='product_name="Stone Transfer" and process_name="Factory To Karigar" and karigar = "Factory" and archive=0';
    
  return array(
    'page_title'          => 'Stone Issue Department List',
