...
function getTableSettings() {
  $show = (isset($_GET['show_all'])) ? $_GET['show_all'] : '';
    if($show=='yes') $where='product_name="Stone Transfer" and process_name="Karigar To Factory" and karigar != "Factory"';
    else $where='product_name="Stone Transfer" and process_name="Karigar To Factory" and karigar != "Factory" and archive=0';
   
  return array(
    'page_title'          => 'Stone Karigar Issue Department List',
    ...
    'search_url'          => 'stone_karigar_issue_departments',
    'add_title'           => 'Issue Stone',
    'export_title'        => '',
    'edit'                => '',
...
function get_field_attribute($table, $field) {
  ...
  $attributes = array(
    ...
    'karigar' => array('Issue from Karigar to Factory', 'Select Karigar', TRUE, '', TRUE),
