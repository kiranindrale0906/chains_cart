...
class Stone_issue_model extends Process_model {
  protected $next_process_model = '';
  
  public $router_class = 'stone_issues';
  public $departments = array('Start');
  
  public function __construct($data = array()) {
    parent::__construct($data);
    $this->attributes['product_name'] = 'Stone Issue';
    $this->attributes['process_name'] = 'Issue';
    $this->attributes['chain_name'] = 'Issue';
    $this->department_not_deleted=array('Start');
    $this->load->model(array('processes/Process_field_model', 'receipt_departments/Chain_receipt_model'));
  }
  ...
  public function after_save($action) {
    // $chain_receipt = array('process_sequence' => 0,
    ...
    // $chain_receipt_obj = new Chain_receipt_model($chain_receipt);
    // $chain_receipt_obj->save(true);
