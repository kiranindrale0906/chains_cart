...
function getTableSettings($data=array(),$where=array()) {
    ...
    $where = 'packing_slip_id ='.$packing_slip_id;
...
function get_field_attribute($table, $field) {
  ...
  $attributes['packing_slip_details'] = array(
    ...
    'net_weight' => array('Net weight', 'Net weight', TRUE, '', TRUE),
    'stone' => array('Stone', 'Stone', TRUE, '', TRUE),
    'colour' => array('Colour', 'Colour', TRUE, '', TRUE),
    'code' => array('Code', 'Code', TRUE, '', TRUE),
    'description' => array('Description', 'Description', TRUE, '', TRUE),
  );
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'export_internals/packing_slip_details';
