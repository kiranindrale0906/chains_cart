...
function getTableSettings() {
  $data = array(
    'page_title'          => 'Export Internal Receipt List',
    'primary_table'       => 'processes',
    'default_column'      => 'id',
    'table'               => 'processes',
    'join_columns'        => '',
    'join_type'           => '',
    'where'               => 'product_name="Export Internal" AND process_name="Export Internal Receipt"',
    'where_ids'           => '',
    'order_by'            => 'id desc',
    'limit'               => "20",
    ...
    'search_url'          => 'export_internal_receipts',
    'export_title'        => '',
    'add_title'           => 'Add Export Internal',
    'edit'                => '',
  );
  return $data;
}
