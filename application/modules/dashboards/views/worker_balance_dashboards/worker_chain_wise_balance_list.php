<?php 
if(!empty($total_worker_wise_balances)){
foreach ($total_worker_wise_balances as $total_worker_balance_index => $chain_wise_columns) {
?>
<div class='col-sm-6'>
    <br><h6 class="bold"><?=$total_worker_balance_index?></h6>
