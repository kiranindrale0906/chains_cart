...
<?php  if(isset($deparment_process_balance) || (isset($deparment_process_balance) && empty($deparment_process_balance))){?>
<h6>Department Wise List</h6>
<div class='row'>
<?php
 foreach($deparment_process_balance as $process_key => $process_value){
  ?>
    <div class="col-sm-6">
