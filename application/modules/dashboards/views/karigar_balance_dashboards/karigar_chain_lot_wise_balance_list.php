<?php 
if(!empty($total_karigar_lot_wise_balances)){
foreach ($total_karigar_lot_wise_balances as $total_karigar_lot_balance_index => $chain_lot_wise_columns) {
?>
<div class='col-sm-6'>
    <br><h6 class="bold"><?=$total_karigar_lot_balance_index?></h6>
