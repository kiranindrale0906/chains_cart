...
function getTableSettings() {
  return array(
    'page_title'          => 'Internal Receipt List',
    'primary_table'       => 'processes',
    'default_column'      => 'id',
    'table'               => 'processes',
    'join_columns'        => '',
    'join_type'           => '',
    'where'               => 'product_name="Internal" and department_name="Start"',
    'where_ids'           => '',
    'order_by'            => 'id desc',
    'limit'               => "20",
    ...
    'search_url'          => 'internal_receipts',
    'add_title'           => 'Add Internal Receipt',
    'export_title'        => '',
    'edit'                => '',
  );
}
...
function list_settings() {
  return array(
    ...
    array("Hook KDM Purity", "hook_kdm_purity", TRUE, "hook_kdm_purity", TRUE, TRUE,'FORMAT(hook_kdm_purity,4) as hook_kdm_purity'),
...
function get_field_attribute($table, $field) {
  ...
  $attributes = array(
    ...
    'hook_kdm_purity'  => array('Hook Kdm Purity', 'Enter Hook Kdm Purity', TRUE, '', TRUE),
  );
