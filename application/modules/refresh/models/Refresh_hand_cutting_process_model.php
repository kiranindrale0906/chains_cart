...
class Refresh_hand_cutting_process_model extends Process_model{
	protected $next_process_model = 'refresh/Refresh_model';
	
	public $router_class = 'refresh_hand_cutting_processes';
	
	public function __construct($data = array()){
		parent::__construct($data);
		$this->attributes['product_name'] = 'Refresh';
		$this->departments = array('Hand Cutting');
		$this->attributes['process_name'] = 'Hand Cutting Process';
		$this->attributes['chain_name'] = 'Refresh';

		$this->department_not_deleted = array('Start', 'Hand Cutting');
	}
}
