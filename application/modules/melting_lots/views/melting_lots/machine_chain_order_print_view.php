    ...
    <table class="table table-bordered table-sm text-center">
      ...
      <tbody>
        <tr>
          ...
          <td><?php echo $record['settings']['size']; ?></td>
...
<div class ="row">
  <div class="col-sm-4">
    <table class="table table-bordered table-sm text-center">
      <thead>
        <tr>
          <th>KDM WIRE REQUIRED</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td><?php echo round($record['kdm_wire_1_per_inch'], 2); ?></td>
        </tr>
      </tbody>
    </table>
  </div>
  <div class="col-sm-4">
    <table class="table table-bordered table-sm text-center">
      <thead>
        <tr>
          <th>KDM 2 REQUIRED</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td><?php echo round($record['kdm_2_per_inch'], 2); ?></td>
        </tr>
      </tbody>
    </table>
  </div>
...
<script type="text/javascript">
  window.onload = function() {
    document.title = 'Machine chain order details - Order ID <?php echo $record['id']; ?> & Melting lot id <?php echo $record['melting_lot_id']; ?> ';
    window.print()
  }
</script>