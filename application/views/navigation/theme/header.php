<header class="d-flex justify-content-between align-items-center fixed-top">
  <div>
    ...
    <button class="btn_icon btn_slide_sidemenu btn_slide_sidemenu_js">
  ...
  <div class="d-flex align-items-center justify-content-end float-right">
    <div class="calculate_div pr-3">
      <label class="medium search_label">Calculate :</label>
      <input  type="text" id="calculate" class="search_input">
      <label class="medium search_label_total">Total:</label>
      <span id="cal"></span>     
      <div id="errors"></div>       
    </div>
    <?php if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])):?>
      <ul class="nav">      
        <li class="nav-item usermenu">
          <div class="dropdown">
            <a href="#" class="nav-link cyan" data-toggle="dropdown">
             <i class="fas fa-user blue"></i>
            </a>
            <div class="dropdown-menu animated slideIn">            
              <ul class="list-unstyled menu-list">
                <li><a href="#" class="link-black"><i class="fas fa-user font30 gray align-middle"></i></i> <span class="d-inline-block text-left pl-2 align-middle"><?= $_SESSION['name']; ?> <br><?= $_SESSION['email_id']; ?></span></a></li>                     
                <div class="dropdown-divider"></div>
                <li>
                  <a href="<?= ADMIN_PATH.'users/logout' ?>" class="cyan">
