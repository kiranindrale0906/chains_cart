<header class="d-flex justify-content-between align-items-center fixed-top">
  <div>
    <a href="<?php echo base_url() ?>">
      <img src="<?= ADMIN_LAYOUTS_PATH ?>images/common/logo.png" width="180px" alt="user" class="dark-logo">
    </a> 
    <button class="btn btn-lg btn_icon btn_slide_sidemenu btn_slide_sidemenu_js">
      <i class="fal fa-align-justify black"></i>
    </button>    
  </div>  
  <div class="d-flex align-items-center justify-content-end float-right">
    ...
    <?php else:?>
      <a href="<?= base_url().'users/login/create'?>" class="black medium">Login</a>
    <?php endif;?>  
  </div>
</header>