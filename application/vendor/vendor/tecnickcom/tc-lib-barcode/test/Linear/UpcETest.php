...
class UpcETest extends TestUtil
{
    ...
    public function testGetGrid()
    {
        ...
        $bobj = $testObj->getBarcodeObj('UPCE', '725270');
        $grid = $bobj->getGrid();
