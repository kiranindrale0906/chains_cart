...
function get_category_one() {
  return array('Rope Chain' => array(array('id'=>'04-grams','name'=>'04-grams'),
                                     array('id'=>'05-grams','name'=>'05-grams'),
                                     array('id'=>'06-grams','name'=>'06-grams'),
                                     array('id'=>'08-grams','name'=>'08-grams'),
                                     array('id'=>'10-grams','name'=>'10-grams'),
                                     array('id'=>'12-grams','name'=>'12-grams'),
                                     array('id'=>'16-grams','name'=>'16-grams'),
                                     array('id'=>'rope-2.5','name'=>'ROPE 2.5')),
               'Office Outside Hollow Pipe' => array(array('id'=>'Imp_Pipe','name'=>'Imp Pipe'),
                                   array('id'=>'Solid_Pipe','name'=>'Solid Pipe')));
}

function get_category_two() {
   if(HOST!='ARF')
  return array('Rope Chain' => array('04-grams' => array(array('id' => '29', 'name' => '29')),
                                     '05-grams' => array(array('id' => '27', 'name' => '27')),
                                     '06-grams' => array(array('id' => '29', 'name' => '29')),
                                     '08-grams' => array(array('id' => '27', 'name' => '27')),
                                     '10-grams' => array(array('id' => '29', 'name' => '29')),
                                     '12-grams' => array(array('id' => '25', 'name' => '25')),
                                     '16-grams' => array(array('id' => '33', 'name' => '33')),
                                     'rope-2.5' => array(array('id' => '27', 'name' => '27'))),
               'Solid Rope Chain' => array('04-grams' => array(array('id' => '29', 'name' => '29')),
                                     '06-grams' => array(array('id' => '29', 'name' => '29')),
                                     '08-grams' => array(array('id' => '27', 'name' => '27')),
                                     '10-grams' => array(array('id' => '33', 'name' => '33')),
                                     '12-grams' => array(array('id' => '25', 'name' => '25')),
                                     '16-grams' => array(array('id' => '33', 'name' => '33')),
                                     'rope-2.5' => array(array('id' => '27', 'name' => '27'))),
               'Round Box Chain'  => array('Bahubali' => array(array('id' => '8', 'name' => '8'),
                                                              array('id' => '12', 'name' => '12'),
                                                               array('id' => '16', 'name' => '16')),
                                           'RB' => array(array('id' => '6', 'name' => '6'),
                                                              array('id' => '8', 'name' => '8'),
                                                               array('id' => '10', 'name' => '10')),
                                           'Spark' => array(array('id' => '08', 'name' => '08'),
                                                            array('id' => '12', 'name' => '12')),
                                           'Walzer' => array(array('id' => '12', 'name' => '12')),
                                           'Skoda' => array(array('id' => '06', 'name' => '06'),
                                                            array('id' => '12', 'name' => '12')),
                                           'Boomer' => array(array('id' => '04', 'name' => '04'),
                                                             array('id' => '12', 'name' => '12')),
                                           'Bombarto_Code' => array(array('id' => '2.5', 'name' => '2.5'),
                                                                    array('id' => '04', 'name' => '04'),
                                                                    array('id' => '12', 'name' => '12')),
                                            'Raes_Code' => array(array('id' => '12', 'name' => '12')),
                                           'Pentagon' => array(array('id' => '12', 'name' => '12')),
                                           'Affair' => array(array('id' => '08', 'name' => '08')),
                                           'New_Mercury' => array(array('id' => '6', 'name' => '6'),array('id' => '8', 'name' => '8'),array('id' => '12', 'name' => '12'))),
               'Machine Chain'  => array('Curb' => array(array('id' => '35', 'name' => '35'),
                                                         array('id' => '40', 'name' => '40'),
                                                         array('id' => '45', 'name' => '45'),
                                                         array('id' => '50', 'name' => '50'),
                                                         array('id' => '60', 'name' => '60'),
                                         ...
                                         'Anchor' => array(array('id' => '35', 'name' => '35'),
                                                           array('id' => '40', 'name' => '40'),
                                                           array('id' => '45', 'name' => '45'),
                                                           array('id' => '50', 'name' => '50'),
                                                           array('id' => '60', 'name' => '60'),
                                                           array('id' => '65', 'name' => '65')),
                                         'Spyke' => array(array('id' => 'HR_120/60', 'name' => 'HR-120/60'),
                                                          array('id' => 'HR_100/50', 'name' => 'HR-100/50'),
                                                          array('id' => 'HR_80/40', 'name' => 'HR-80/40'),
                                                          array('id' => 'HR_70/35', 'name' => 'HR-70/35'),
                                                          array('id' => 'HR_40/80', 'name' => 'HR-40/80')),
                                         'Curb_Figaro' => array(array('id' => '60', 'name' => '60'),array('id' => '80', 'name' => '80'),array('id' => '100', 'name' => '100')),
                                         'Box_10' => array(array('id' => '1.8*0.35', 'name' => '1.8*0.35')),
                                         'Box_15' => array(array('id' => '0.90*0.29', 'name' => '0.90*0.29')),),
               'Choco Chain'  => array('Stampoo' => get_choco_chain_design_code(50),
                                       'Choco' => get_choco_chain_design_code(200),
                                       'Milano' => get_choco_chain_design_code(10)),
               'Rolex Chain'  => array('Stampoo' => get_choco_chain_design_code(50),
                                       'Choco' => get_choco_chain_design_code(200),
                                       'Milano' => get_choco_chain_design_code(10)),
               'KA Chain'  => array('BOX_CHAIN' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                         array('id' => 'Powder', 'name' => 'Powder')),
                                    // 'Box_Laser' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                    //                         array('id' => 'Powder', 'name' => 'Powder')),
                                    // 'Left_Right_Chain' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                    //                             array('id' => 'Powder', 'name' => 'Powder')),
                                    'LR' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                                array('id' => 'Powder', 'name' => 'Powder')),
                                    'ANCHOR' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                                array('id' => 'Powder', 'name' => 'Powder')),
                                    // 'Anchor_Figaro' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                    //                    array('id' => 'Powder', 'name' => 'Powder')),
                                    'ANCHOR_FASTI' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                       array('id' => 'Powder', 'name' => 'Powder')),
                                    'CF_LR' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                        array('id' => 'Powder', 'name' => 'Powder')),
                                    'C_COMP' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                        array('id' => 'Powder', 'name' => 'Powder')),
                                    'LL_LR' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                        array('id' => 'Powder', 'name' => 'Powder')),
                                    'DOUBLE_C_LR' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                        array('id' => 'Powder', 'name' => 'Powder')),
                                    'SPYKE' => array(array('id' => 'Laser', 'name' => 'Laser'),
                                                           array('id' => 'Powder', 'name' => 'Powder')),));
}

function get_category_three() {
   if(HOST!='ARF')
  return array('Rope Chain' => array('04-grams' => array('29' => array(array('id' => '40', 'name' => '40'))),
                                     '05-grams' => array('27' => array(array('id' => '50', 'name' => '50'))),
                                     '06-grams' => array('29' => array(array('id' => '50', 'name' => '50'))),
                                     '08-grams' => array('27' => array(array('id' => '60', 'name' => '60'))),
                                     '10-grams' => array('29' => array(array('id' => '65', 'name' => '65'))),
                                     '12-grams' => array('25' => array(array('id' => '80', 'name' => '80'))),
                                     '16-grams' => array('33' => array(array('id' => '80', 'name' => '80'))),
                                     'rope-2.5' => array('27' => array(array('id' => '35', 'name' => '35')))),
               'Solid Rope Chain' => array('04-grams' => array('29' => array(array('id' => '40', 'name' => '40'))),
                                     '06-grams' => array('29' => array(array('id' => '50', 'name' => '50'))),
                                     '08-grams' => array('27' => array(array('id' => '60', 'name' => '60'))),
                                     '10-grams' => array('33' => array(array('id' => '60', 'name' => '60'))),
                                     '12-grams' => array('25' => array(array('id' => '80', 'name' => '80'))),
                                     '16-grams' => array('33' => array(array('id' => '80', 'name' => '80'))),
                                     'rope-2.5' => array('27' => array(array('id' => '35', 'name' => '35')))),
               'Round Box Chain' => array('Bahubali' => array('8' => array(array('id' => '15', 'name' => '15')),
                                                              '12' => array(array('id' => '17', 'name' => '17')),
                                                              '16' => array(array('id' => '18', 'name' => '18'))),
                                          'RB' => array('6' => array(array('id' => '15', 'name' => '15')),
                                                              '8' => array(array('id' => '16', 'name' => '16')),
                                                              '10' => array(array('id' => '19', 'name' => '19'))),
                                          'Spark' => array('08' => array(array('id' => '14', 'name' => '14')),
                                                           '12' => array(array('id' => '16', 'name' => '16'))),
                                          'Walzer' => array('12' => array(array('id' => '20', 'name' => '20'))),
                                          'Skoda' => array('06' => array(array('id' => '16', 'name' => '16')),
                                                           '12' => array(array('id' => '20', 'name' => '20'))),
                                          'Boomer' => array('04' => array(array('id' => '14', 'name' => '14')),
                                                            '12' => array(array('id' => '22', 'name' => '22'))),
                                          'Bombarto_Code' => array('2.5' => array(array('id' => '12', 'name' => '12')),'04' => array(array('id' => '12', 'name' => '12')),
                                                                   '12' => array(array('id' => '18', 'name' => '18'))),
                                          'Raes_Code' => array('12' => array(array('id' => '20', 'name' => '20'))),
                                          'Pentagon' => array('12' => array(array('id' => '17', 'name' => '17'))),
                                          'Affair' => array('08' => array(array('id' => '16', 'name' => '16'),array('id' => '20', 'name' => '20'))),
                                          'New_Mercury' => array(
                                                      '6' => array(array('id' => '15', 'name' => '15')),
                                                      '8' => array(array('id' => '15', 'name' => '15')),
                                                      '12' => array(array('id' => '19', 'name' => '19')))),
               'Machine Chain' => array('Curb' => array('35' => array(array('id' => 'GF-Gold_Finger', 
                                                                            'name' => 'GF-Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Long Link', 'name' => 'Long Link'),
                                                                      array('id' => 'Short Link', 'name' => 'Short Link'),
                                                                      array('id' => 'Figaro', 'name' => 'Figaro'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '40' => array(array('id' => 'GF-Gold_Finger', 
                                                                            'name' => 'GF-Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      ...
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '45' => array(array('id' => 'GF-Gold_Finger', 
                                                                            'name' => 'GF-Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      ...
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '50' => array(array('id' => 'GF-Gold_Finger', 'name' => 'Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '60' => array(array('id' => 'GF-Gold_Finger', 'name' => 'Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '70' => array(array('id' => 'GF-Gold_Finger', 'name' => 'Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '80' => array(array('id' => 'GF-Gold_Finger', 'name' => 'Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '90' => array(array('id' => 'GF-Gold_Finger', 'name' => 'Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      array('id' => 'Triple GF', 'name' => 'Triple GF'),
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                                        '120' => array(array('id' => 'GF-Gold_Finger', 'name' => 'Gold Finger'),
                                                                      array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                      array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                      array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                      array('id' => 'Double GF', 'name' => 'Double GF'),
                                                                      ...
                                                                      array('id' => 'Plain Curb', 'name' => 'Plain Curb')),
                                        'Anchor' => array(
                                          '35' => array(  array('id' => 'Ajgar', 'name' => 'Ajgar'),
                                                          array('id' => 'Cobra', 'name' => 'Cobra'),
                                                          array('id' => 'Kamal', 'name' => 'Kamal'),
                                                          array('id' => 'Chandani', 'name' => 'Chandani'),
                                                          array('id' => 'Mogambo', 'name' => 'Mogambo'),
                                                          array('id' => 'Sundari', 'name' => 'Sundari'),
                                                          array('id' => 'Shahenshah', 'name' => 'Shahenshah')),
                                          '40' => array( array('id' => 'Ajgar', 'name' => 'Ajgar'),
                                                          array('id' => 'Cobra', 'name' => 'Cobra'),
                                                          array('id' => 'Kamal', 'name' => 'Kamal'),
                                                          array('id' => 'Chandani', 'name' => 'Chandani'),
                                                          array('id' => 'Mogambo', 'name' => 'Mogambo'),
                                                          array('id' => 'Sundari', 'name' => 'Sundari'),
                                                          array('id' => 'Shahenshah', 'name' => 'Shahenshah')),
                                          '45' => array( array('id' => 'Ajgar', 'name' => 'Ajgar'),
                                                          array('id' => 'Cobra', 'name' => 'Cobra'),
                                                          array('id' => 'Kamal', 'name' => 'Kamal'),
                                                          array('id' => 'Chandani', 'name' => 'Chandani'),
                                                          array('id' => 'Mogambo', 'name' => 'Mogambo'),
                                                          array('id' => 'Sundari', 'name' => 'Sundari'),
                                                          array('id' => 'Shahenshah', 'name' => 'Shahenshah')),
                                          '50' => array(array('id' => 'Ajgar', 'name' => 'Ajgar'),
                                                          array('id' => 'Cobra', 'name' => 'Cobra'),
                                                          array('id' => 'Kamal', 'name' => 'Kamal'),
                                                                        array('id' => 'Chandani', 'name' => 'Chandani'),
                                                                        array('id' => 'Mogambo', 'name' => 'Mogambo'),
                                                                        array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                        array('id' => 'Shahenshah', 'name' => 'Shahenshah')),
                                          '60' => array(array('id' => 'Ajgar', 'name' => 'Ajgar'),
                                                          array('id' => 'Cobra', 'name' => 'Cobra'),
                                                          array('id' => 'Kamal', 'name' => 'Kamal'),
                                                                        array('id' => 'Chandani', 'name' => 'Chandani'),
                                                                        array('id' => 'Mogambo', 'name' => 'Mogambo'),
                                                                        array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                        array('id' => 'Shahenshah', 'name' => 'Shahenshah')),
                                          '65' => array(array('id' => 'Short Link', 'name' => 'Short Link'),
                                                          array('id' => 'Long Link', 'name' => 'Long Link'),
                                                          array('id' => 'Figaro', 'name' => 'Figaro'))),
                                        'Spyke' => array('HR_120/60' => array(array('id' => '16-grams', 'name' => '16-grams')),
                                                         'HR_100/50' => array(array('id' => '12-grams', 'name' => '12-grams')),
                                                         'HR_80/40' => array(array('id' => '08-grams', 'name' => '08-grams')),
                                                         'HR_70/35' => array(array('id' => '06-grams', 'name' => '06-grams')),
                                                         'HR_40/80' => array(array('id' => '10-grams', 'name' => '10-grams'))),
                                        'Curb_Figaro' => array('60' => array(array('id' => 'Gold_Finger', 
                                                                                   'name' => 'Gold Finger'),
                                                                             array('id' => 'Khiladi', 'name' => 'Khiladi'),
                                                                             array('id' => 'Sundari', 'name' => 'Sundari'),
                                                                             array('id' => 'Rolex', 'name' => 'Rolex'),
                                                                             array('id' => 'Tendulkar', 'name' => 'Tendulkar'))),
                                        'Box_10' => array('1.8*0.35' => array(array('id' => 'Shiva', 'name' => 'Shiva'),
                                                                             array('id' => 'Sadak', 'name' => 'Sadak'),
                                                                             array('id' => 'Road King', 'name' => 'Road King'),
                                                                             array('id' => 'Indrajit', 'name' => 'Indrajit'))),
                                        'Box_15' => array('0.90*0.29' => array(array('id' => 'Shiva', 'name' => 'Shiva'),
                                                                             array('id' => 'Sadak', 'name' => 'Sadak'),
                                                                             array('id' => 'Road King', 'name' => 'Road King'),
                                                                             array('id' => 'Indrajit', 'name' => 'Indrajit')))),
'KA Chain' => array(
                'BOX_CHAIN' => array('Laser' => array(array('id' => '0.21 box', 'name' =>'0.21 box'),
                                                                         array('id' => '0.26 box', 'name' =>'0.26 box'),
                                                                         array('id' => '0.265 box', 'name' =>'0.265 box'),
                                                                         array('id' => '0.31 box', 'name' =>'0.31 box'), 
                                                                         array('id' => '0.33 box', 'name' =>'0.33 box'), 
                                                                         array('id' => '0.38 box', 'name' =>'0.38 box'), 
                                                                         array('id' => '0.46 box', 'name' =>'0.46 box'), 
                                                                         array('id' => '0.57 box', 'name' =>'0.57 box'), 
                                                                         array('id' => '0.75 box', 'name' =>'0.75 box'), 
                                                                         array('id' => '0.85 box', 'name' =>'0.85 box'), 
                                                                         array('id' => '0.95 box', 'name' =>'0.95 box'), 
                                                                         array('id' => '1.05 box', 'name' =>'1.05 box'),
                                                                         array('id' => '1.1 box', 'name' =>'1.1 box'),
                                                                         array('id' => '1.3 box', 'name' =>'1.3 box')),
                                                        'Powder' => array(array('id' => '0.21 box', 'name' =>'0.21 box'),
                                                                         array('id' => '0.26 box', 'name' =>'0.26 box'),
                                                                         array('id' => '0.265 box', 'name' =>'0.265 box'),
                                                                         array('id' => '0.31 box', 'name' =>'0.31 box'), 
                                                                         array('id' => '0.33 box', 'name' =>'0.33 box'), 
                                                                         ...
                                                                         array('id' => '1.1 box', 'name' =>'1.1 box'),
                                                                         array('id' => '1.3 box', 'name' =>'1.3 box'))),
               'ANCHOR' => array('Laser' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.45', 'name' =>'0.45'),
                                                      array('id' => '0.50', 'name' =>'0.50'),
                                                      ),
                                    'Powder' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.45', 'name' =>'0.45'),
                                                      array('id' => '0.50', 'name' =>'0.50')
                                                      )),
               // 'Box_Laser' => array('Laser' => array(array('id' => '0.26', 'name' =>'0.26'),
               //                                        array('id' => '0.31', 'name' =>'0.31'),
               //                                        array('id' => '0.38', 'name' =>'0.38'),
               //                                        array('id' => '0.45', 'name' =>'0.45'),
               //                                        ),
               //                      'Powder' => array(array('id' => '0.26', 'name' =>'0.26'),
               //                                        array('id' => '0.31', 'name' =>'0.31'),
               //                                        array('id' => '0.38', 'name' =>'0.38'),
               //                                        array('id' => '0.45', 'name' =>'0.45'),
               //                                        )),
               'ANCHOR_FASTI' => array('Laser' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.35', 'name' =>'0.35'),
                                                      array('id' => '0.40', 'name' =>'0.40'),
                                                      ),
                                    'Powder' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.35', 'name' =>'0.35'),
               ...
               // 'Anchor_Figaro' => array('Laser' => array(array('id' => '0.50', 'name' =>'0.50'),
               //                                        array('id' => '0.70', 'name' =>'0.70'),
               //                                        ),
               //                      'Powder' => array(array('id' => '0.50', 'name' =>'0.50'),
               //                                        array('id' => '0.70', 'name' =>'0.70'),
               //                                        )),
               
               'LR' => array('Laser' => array(
                                                      array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.355', 'name' =>'0.355'),
                                                      array('id' => '0.41', 'name' =>'0.41'),
                                                      array('id' => '0.52', 'name' =>'0.52'),
                                                      
                                                      array('id' => '0.40', 'name' =>'0.40'),
                                                      array('id' => '0.45', 'name' =>'0.45'),
                                                      array('id' => '0.46', 'name' =>'0.46'),
                                                      array('id' => '0.50', 'name' =>'0.50'),
                                                      array('id' => '0.50_loose', 'name' =>'0.50 (Loose)'),
                                                      array('id' => '0.60', 'name' =>'0.60'),
                                                      array('id' => '0.60_loose', 'name' =>'0.60 (Loose)'),
                                                      array('id' => '0.70', 'name' =>'0.70'),
                                                      array('id' => '0.80', 'name' =>'0.80'),
                                                      array('id' => '0.90', 'name' =>'0.90'),
                                                      array('id' => '1.10', 'name' =>'1.10'),
                                                      ),
                                    'Powder' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.355', 'name' =>'0.355'),
               ...
               'CF_LR' => array('Laser' => array(array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.35', 'name' =>'0.35'),
                                                      array('id' => '0.40', 'name' =>'0.40'),
                                                      array('id' => '0.45', 'name' =>'0.45'),
                                                      array('id' => '0.50', 'name' =>'0.50'),
                                ...
                                'Powder' => array(array('id' => '0.30', 'name' =>'0.30'),
                                                       array('id' => '0.35', 'name' =>'0.35'),
                                                       array('id' => '0.40', 'name' =>'0.40'),
                                                       array('id' => '0.45', 'name' =>'0.45'),
                                                       array('id' => '0.50', 'name' =>'0.50'),
               ...
               'C_COMP' => array('Laser' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.40', 'name' =>'0.40'),
                                                      array('id' => '0.50', 'name' =>'0.50'),
                                                      array('id' => '0.60', 'name' =>'0.60'),
               ...
               'LL_LR' => array('Laser' => array(array('id' => '0.35', 'name' =>'0.35'),
                                                      array('id' => '0.40', 'name' =>'0.40'),
                                                      ),
                                    'Powder' => array(array('id' => '0.35', 'name' =>'0.35'),
                                                      array('id' => '0.40', 'name' =>'0.40'),
                                                      )),
               'DOUBLE_C_LR' => array('Laser' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.35', 'name' =>'0.35'),
                                                      array('id' => '0.50', 'name' =>'0.50'),
                                                      array('id' => '0.70', 'name' =>'0.70'),
                                                      ),
               ...
               'SPYKE' => array('Laser' => array(array('id' => '0.25', 'name' =>'0.25'),
                                                      array('id' => '0.30', 'name' =>'0.30'),
                                                      array('id' => '0.35', 'name' =>'0.35'),
                                                      ),
                                    'Powder' => array(array('id' => '0.25', 'name' =>'0.25'),
...
function get_category_four() {
  $data=array();
  if(HOST!='ARF'){
  return array('Round Box Chain' => array('Bahubali' => array('8' => array('15' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone'),
                                                                                          array('id' => 'Two_Tone', 
                                                                                                'name' => 'Two Tone'))),
                                                              '12' => array('17' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone'),
                                                                                          array('id' => 'Two_Tone', 
                                                                                                'name' => 'Two Tone'))),
                                                              '16' => array('18' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone'),
                                                                                          array('id' => 'Two_Tone', 
                                                                                                'name' => 'Two Tone')))),
                                          'RB' => array('6' => array('15' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone'),
                                                                                          array('id' => 'Two_Tone', 
                                                                                                'name' => 'Two Tone'))),
                                                              '8' => array('16' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone'),
                                                                                          array('id' => 'Two_Tone', 
                                                                                                'name' => 'Two Tone'))),
                                                              '10' => array('19' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone'),
                                                                                          array('id' => 'Two_Tone', 
                                                                                                'name' => 'Two Tone')))),
                                          'Spark' => array('08' => array('14' => array(array('id' => 'Single_Tone', 
                                                                                            'name' => 'Single Tone'),
                                                                                      array('id' => 'Two_Tone', 
                                                                                            'name' => 'Two Tone'))),
                                                           '12' => array('16' => array(array('id' => 'Single_Tone', 
                                                                                             'name' => 'Single Tone'),
                                                                                       array('id' => 'Two_Tone', 
                                                                                             'name' => 'Two Tone')))),
                                          'Walzer' => array('12' => array('20' => array(array('id' => 'Single_Tone', 
                                                                                              'name' => 'Single Tone'),
                                                                                         array('id' => 'Two_Tone', 
                                                                                               'name' => 'Two Tone')))),
                                          'Skoda' => array('06' => array('16' => array(array('id' => 'Single_Tone', 
                                                                                             'name' => 'Single Tone'),
                                                                                       array('id' => 'Two_Tone', 
                                                                                             'name' => 'Two Tone'))),
                                                           '12' => array('20' => array(array('id' => 'Single_Tone', 
                                                                                             'name' => 'Single Tone'),
                                                                                       array('id' => 'Two_Tone', 
                                                                                             'name' => 'Two Tone')))),
                                          'Boomer' => array('04' => array('14' => array(array('id' => 'Single_Tone', 
                                                                                             'name' => 'Single Tone'),
                                                                                        array('id' => 'Two_Tone', 
                                                                                             'name' => 'Two Tone'))),
                                                            '12' => array('22' => array(array('id' => 'Single_Tone', 
                                                                                               'name' => 'Single Tone')))),
                                          'Bombarto_Code' => array('04' => array('12' => array(array('id' => 'Single_Tone', 
                                                                                                     'name' => 'Single Tone'))),
                                                                   '12' => array('18' => array(array('id' => 'Single_Tone', 
                                                                                                  'name' => 'Single Tone')))),
                                          
                                          'Raes_Code' => array('12' => array('20' => array(array('id' => 'Single_Tone', 
                                                                                                 'name' => 'Single Tone'),
                                                                                           array('id' => 'Two_Tone', 
                                                                                                 'name' => 'Two Tone')))),
                                          'Pentagon' => array('12' => array('17' => array(array('id' => 'Single_Tone', 
                                                                                                'name' => 'Single Tone')))),
                                          'Affair' => array('08' => array('16' => array(array('id' => 'Single_Tone', 
                                                                                              'name' => 'Single Tone'),
                                                                                        array('id' => 'Two_Tone', 
                                                                                              'name' => 'Two Tone')),
                                          '20' => array(array('id' => 'Single_Tone', 
                                                                                              'name' => 'Single Tone'),
                                                                                        array('id' => 'Two_Tone', 
                                                                                              'name' => 'Two Tone')))),
                                          'New_Mercury' => array('6' => array('15' => array(array('id' => 'Single_Tone', 
                                                                                              'name' => 'Single Tone'),
                                                                                        array('id' => 'Two_Tone', 
                                                                                              'name' => 'Two Tone'))),
                                          '8' => array('15' => array(array('id' => 'Single_Tone', 
                                                                                              'name' => 'Single Tone'),
                                                                                        array('id' => 'Two_Tone', 
                                                                                              'name' => 'Two Tone'))),
                                          '12' => array('19' => array(array('id' => 'Single_Tone', 
                                                                                              'name' => 'Single Tone'),
                                                                                        array('id' => 'Two_Tone', 
                                                                                              'name' => 'Two Tone'))))));
  }else{
